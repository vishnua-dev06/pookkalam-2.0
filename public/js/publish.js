function publishDesign() {
  ...
  modal.innerHTML = `
    <div class="bg-card p-8 rounded-lg shadow-xl max-w-md w-full">
      ...
      <p class="text-muted-foreground mb-4">We'd love for you to share your design! Approved submissions may be featured by POOVUM CODEUM for others to see and appreciate.</p>
...
function submitDesign(userName) {
  ...
  logo.onload = function () {
    ...
    canvasCtx.fillText(`POOVUM CODEUM `, textX, textY);
    ...
    img.onload = function () {
      ...
      ctx.fillStyle = 'black';
      ctx.textAlign = 'left';
      ctx.fillText(`POOVUM CODEUM `, textX, 784); // Adjusted position to be within bounds
